...
Properties {
    ...
    $SrcRootDir = "$PSScriptRoot\Output\$ModuleName"
    [System.Diagnostics.CodeAnalysis.SuppressMessage('PSUseDeclaredVarsMoreThanAssigments', '')]
    ...
    #
    [System.Diagnostics.CodeAnalysis.SuppressMessage('PSUseDeclaredVarsMoreThanAssigments', '')]
    $CertSubjectName = 'E=isadmins@groups.gaylor.com, CN=Gaylor Electric Inc., OU=Information Services, O=Gaylor Electric, L=Indianapolis, S=Indiana, C=US'
